break;
            ...
            default:
                activeWallet = 'main';
                walletNameContainer.textContent = 'Main Wallet 1';
        }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize back buttons on send/receive screens
    const backButtons = document.querySelectorAll('.back-button');
    backButtons.forEach(button => {
        button.addEventListener('click', function() {
            document.getElementById('send-screen').classList.add('hidden');
            document.getElementById('receive-screen').classList.add('hidden');
            document.getElementById('wallet-screen').classList.remove('hidden');
        });
    });
    
    // Generate QR code for receive screen
...
function showSendScreen(tokenId) {
    ...
    document.getElementById('amount-input').placeholder = `${token.symbol} Amount`;
